...
var staffDataHoliday = require('../../../../app/views/assess/v8-5/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/assess/v8-5/staff-data-2.js')
var slotsData = require('../../../../app/views/assess/v8-5/slots-data.js')
var slotsData2 = require('../../../../app/views/assess/v8-5/slots-data-2.js')
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/assess/v8-5"
  res.locals.manageStaffPath = "assess/v8-5/capacity/manage-staff"
...
router.post('/booking/mendez_timeline-arrived', function(req, res, next){
    ...
    res.locals.arrivedTime = arrivedTime;
    res.render("assess/v8-5/booking/mendez_timeline-arrived");
  })
...
router.post('/booking/cancel-appointment', function(req, res, next){
    ...
    if(req.body.change_now === "true"){
      ...
      res.redirect('/assess/v8-5/appointments-changed?reason=' + req.body.reason)
    }
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/assess/v8-5/data/centres.js'),
...
router.get('/assessment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/assess/v8-5/data/centres.js')
  next()
})

router.get('/appointments', function(req, res, next){
  var customers = require('../../../../app/views/assess/v8-5/data/referrals.js')
  if(req.query.booked){
...
router.get('/booked_appointments', function(req, res, next){
  res.locals.customers = require('../../../../app/views/assess/v8-5/data/booked.js')
  next()
})
...
router.get('/booking/referrals/:customerId', function(req, res, next){
  ...
  res.render("assess/v8-5/booking/customer-referral");
})

router.get('/booking/booked/:customerId', function(req, res, next){
  var customers = require('../../../../app/views/assess/v8-5/data/booked.js');

  res.locals.customer = customers.filter(customer => customer._id === req.params.customerId)[0];
  res.render("assess/v8-5/booking/customer-booked");
})


router.get('/capacity/manage-centre/:centreId*', function(req, res, next){
  getCentreDetails(req, res)
  res.locals.staff = require('../../../../app/views/assess/v8-5/data/staff.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId', function(req, res, next){
  res.render("assess/v8-5/capacity/manage-centre/index")
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("assess/v8-5/capacity/manage-staff/index");
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/assess/v8-5/data/staff.js');
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId', function(req, res, next){
  res.render("assess/v8-5/capacity/manage-staff/staff-profile");
})

router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/:section', function(req, res, next){
  res.render("assess/v8-5/capacity/manage-staff/" + req.params.section);
})
...
router.get('/capacity/manage-centre/:centreId/capacity', function(req, res, next){
  ...
  res.render("assess/v8-5/capacity/manage-centre/capacity");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("assess/v8-5/capacity/manage-centre/" + req.params.section)
})

router.get('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  res.locals.person = require('../../../../app/views/assess/v8-5/data/new-staff.js');
  next()
});
