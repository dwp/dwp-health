...
var staffDataHoliday = require('../../../../app/views/assess/v12/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/assess/v12/staff-data-2.js')
var slotsData = require('../../../../app/views/assess/v12/slots-data.js')
var slotsData2 = require('../../../../app/views/assess/v12/slots-data-2.js')
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/assess/v12"
  res.locals.manageStaffPath = "assess/v12/capacity/manage-staff"
...
router.post('/booking/cancel-appointment', function(req, res, next){
    ...
    if(req.body.change_now === "true"){
      ...
      res.redirect('/assess/v12/appointments-changed?reason=' + req.body.reason)
    }
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/assess/v12/data/centres.js'),
...
router.get('/assessment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/assess/v12/data/centres.js')
  next()
})
...
router.get('/booking/referrals/:customerId', function(req, res, next){
  res.render("assess/v12/booking/customer-referral");
})
...
router.get('*/timepicker', function(req, res, next){
  var availableAppointments = require('../../../../app/views/assess/v12/data/availableAppointments.js');
...
router.get('/booking/booked/:customerId/:pageName', function(req, res, next){
  res.render("assess/v12/booking/" + req.params.pageName);
})
...
router.get('/capacity/manage-centre/:centreId*', function(req, res, next){
  ...
  res.locals.staff = require('../../../../app/views/assess/v12/data/staff.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId', function(req, res, next){
  res.render("assess/v12/capacity/manage-centre/index")
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("assess/v12/capacity/manage-staff/index");
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/assess/v12/data/staff.js');
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId', function(req, res, next){
  res.render("assess/v12/capacity/manage-staff/staff-profile");
})

router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/:section', function(req, res, next){
  res.render("assess/v12/capacity/manage-staff/" + req.params.section);
})
...
router.get('/capacity/manage-centre/:centreId/capacity', function(req, res, next){
  ...
  res.render("assess/v12/capacity/manage-centre/capacity");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("assess/v12/capacity/manage-centre/" + req.params.section)
})

router.get('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  res.locals.person = require('../../../../app/views/assess/v12/data/new-staff.js');
  next()
});
