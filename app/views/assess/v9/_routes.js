...
var staffDataHoliday = require('../../../../app/views/assess/v9/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/assess/v9/staff-data-2.js')
var slotsData = require('../../../../app/views/assess/v9/slots-data.js')
var slotsData2 = require('../../../../app/views/assess/v9/slots-data-2.js')
console.log(path)
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/assess/v9"
  res.locals.manageStaffPath = "assess/v9/capacity/manage-staff"
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/assess/v9/data/centres.js'),
...
router.get('/assessment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/assess/v9/data/centres.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("assess/v9/capacity/manage-staff/index");
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/assess/v9/data/staff.js');
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId', function(req, res, next){
  res.render("assess/v9/capacity/manage-staff/staff-profile");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("assess/v9/capacity/manage-centre/" + req.params.section)
})

router.get('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  res.locals.person = require('../../../../app/views/assess/v9/data/new-staff.js');
  next()
});
