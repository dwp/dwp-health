...
var staffDataHoliday = require('../../../../app/views/assess/v8-3/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/assess/v8-3/staff-data-2.js')
var slotsData = require('../../../../app/views/assess/v8-3/slots-data.js')
var slotsData2 = require('../../../../app/views/assess/v8-3/slots-data-2.js')
console.log(path)
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/assess/v8-3"
  res.locals.manageStaffPath = "assess/v8-3/capacity/manage-staff"
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/assess/v8-3/data/centres.js'),
...
router.get('/assessment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/assess/v8-3/data/centres.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId*', function(req, res, next){
  ...
  res.locals.staff = require('../../../../app/views/assess/v8-3/data/staff.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId', function(req, res, next){
  res.render("assess/v8-3/capacity/manage-centre/index")
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("assess/v8-3/capacity/manage-staff/index");
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/assess/v8-3/data/staff.js');
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId', function(req, res, next){
  res.render("assess/v8-3/capacity/manage-staff/staff-profile");
})

router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/:section', function(req, res, next){
  res.render("assess/v8-3/capacity/manage-staff/" + req.params.section);
})
...
router.get('/capacity/manage-centre/:centreId/capacity', function(req, res, next){
  ...
  res.render("assess/v8-3/capacity/manage-centre/capacity");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("assess/v8-3/capacity/manage-centre/" + req.params.section)
})

router.get('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  res.locals.person = require('../../../../app/views/assess/v8-3/data/new-staff.js');
  next()
});
