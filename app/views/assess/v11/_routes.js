...
var staffDataHoliday = require('../../../../app/views/assess/v11/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/assess/v11/staff-data-2.js')
var slotsData = require('../../../../app/views/assess/v11/slots-data.js')
var slotsData2 = require('../../../../app/views/assess/v11/slots-data-2.js')
var moment = require('moment')
var commentsData = require('../../../../app/views/assess/v11/data/comments.js');
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/assess/v11"
  res.locals.manageStaffPath = "assess/v11/capacity/manage-staff"
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/assess/v11/data/centres.js'),
...
router.get('/booked_appointments', function(req, res, next){
    res.locals.appointments = require('../../../../app/views/assess/v11/data/appointments.js')
    next()
  })
...
router.post('/booking/history', function(req, res, next){
    ...
    res.locals.comments = commentsData
      ...
      res.render("assess/v11/booking/history");
...
router.post('/booking/cancel-appointment', function(req, res, next){
    if(req.body.change_now === "true"){
      ...
      res.redirect('/assess/v11/appointments-changed?reason=' + req.body.reason)
    }
...
router.post('/booking/bobby_timeline', function(req, res, next){
    ...
    commentsData.push({
      ...
      res.render("assess/v11/booking/bobby_timeline");

  })

router.get('/assessment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/assess/v11/data/centres.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId*', function(req, res, next){
  ...
  res.locals.staff = require('../../../../app/views/assess/v11/data/staff.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId', function(req, res, next){
  res.render("assess/v11/capacity/manage-centre/index")
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("assess/v11/capacity/manage-staff/index");
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/assess/v11/data/staff.js');
...
router.get('/capacity/manage-centre/:centreId/capacity*', function(req, res, next){
  ...
  res.render("assess/v11/capacity/manage-centre/capacity");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("assess/v11/capacity/manage-centre/" + req.params.section)
})

router.get('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  res.locals.person = require('../../../../app/views/assess/v11/data/new-staff.js');
  next()
});
...
router.get('/booking/timepicker', function(req, res, next){
  slotsData = require('../../../../app/views/assess/v11/slots-data-booking.js')
